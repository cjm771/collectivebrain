...
require("./threejs-extras/OBJLoader.js");
class Thumbnailer {
    ...
    processThumbnail(thumbnailSpec) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (partObj) {
                partObj.material = new THREE.MeshToonMaterial({
                    color: new THREE.Color(255, 255, 255),
                    emissiveIntensity: 1,
                    wireframe: true,
                    emissive: new THREE.Color(255, 255, 255)
                });
                partObj.material.emissive = new THREE.Color(0, 0, 0);
                partObj.material.color = new THREE.Color(255, 255, 255);
    ...
    getGeometry() {
        ...
        let geometry = loader.parse(this.meshData.toString());
